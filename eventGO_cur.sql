...
ALTER TABLE IF EXISTS public.tickets
    ADD CONSTRAINT tickets_owner_id_fkey FOREIGN KEY (owner_id)
    REFERENCES public.users (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;
...
ALTER TABLE IF EXISTS public.tickets
    ADD CONSTRAINT tickets_ticket_type_id_fkey FOREIGN KEY (ticket_type_id)
...
ALTER TABLE IF EXISTS public.tickets
    ADD CONSTRAINT tickets_transaction_id_fkey FOREIGN KEY (transaction_id)
...
ALTER TABLE IF EXISTS public.waitlist
    ADD CONSTRAINT waitlist_event_id_fkey FOREIGN KEY (event_id)
    REFERENCES public.events (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
...
ALTER TABLE IF EXISTS public.waitlist
    ADD CONSTRAINT waitlist_user_id_fkey FOREIGN KEY (user_id)
    REFERENCES public.users (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE CASCADE;
